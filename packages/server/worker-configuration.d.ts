/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f0d6ceddfc89159c6ef5bd7b849af0c2)
// Runtime types generated with workerd@1.20250823.0 2025-08-07 
declare namespace Cloudflare {
	interface Env {
		PROJECT_LOL: KVNamespace;
		API_KEY: string;
		RIOT_CLIENT_ID: string;
		RIOT_REDIRECT_URI: string;
		CORS_ORIGIN: string;
		DB: D1Database;
	}
}
